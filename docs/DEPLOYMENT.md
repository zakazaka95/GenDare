...
| Deployment transaction | `0xb1e0ec256e6be87d416c66d25e6d282fdb5f4ece40c92fc86cc0652850a4164c` |

Explorer links:

- [Contract](https://explorer-studio-dev.genlayer.com/address/0x5eA37668c8c8F1313d4294C349a7eC8585071135)
- [Deployment transaction](https://explorer-studio-dev.genlayer.com/tx/0xb1e0ec256e6be87d416c66d25e6d282fdb5f4ece40c92fc86cc0652850a4164c)
- [Tracked contract source](../contracts/GenDareV2.py)

## Add Studio Devnet to a wallet

The application requests this network automatically. It can also be added manually:

```text
Network name:     GenLayer Studio Devnet
...
Open the contract in the Studio Devnet Explorer or import its address in Studio, then call `get_stats`.
...
The tracked `contracts/GenDareV2.py` source has SHA-256 `4A6EC9B10F95777411F59F31A33A97BF39B1181E587BD7A6FAD507D6433E22A0`. Use this digest when comparing a downloaded source file with this reviewed release.

To verify source correspondence:

1. inspect [`contracts/GenDareV2.py`](../contracts/GenDareV2.py);
2. confirm `CONTRACT_VERSION = "2.1.2"` and `RECEIPT_SCHEMA = "gendare-receipt-v2"`;
...
1. Open [GenLayer Studio Devnet](https://studio-dev.genlayer.com/).
2. Load the complete contents of `contracts/GenDareV2.py`.
3. Select Studio Devnet and connect the deployment wallet.
...
- `src/lib/injected.ts` defines Studio Devnet and wallet switching;
...
- [ ] All 23 contract unit tests pass.
- [ ] Wallet connection works in Rabby or MetaMask.
- [ ] The app switches or adds chain `61997`.
- [ ] `get_stats` reports contract `2.1.2` and receipt schema `gendare-receipt-v2`.
...
- [ ] Transaction links open on the Studio Devnet Explorer.
